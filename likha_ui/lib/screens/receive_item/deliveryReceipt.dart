...
class Deliveryreceipt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: BottomButton(buttontxt: 'Done', onButtonPressed: () { 
                  ...
                  SizedBox(height: 15,),
                   Expanded(
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          DeliveryreceiptEsign(customerInfo: AppData.customerInfo, eSignature: eSignature, orderInfo: AppData.orderInfo, border: 0,),
                          SizedBox(height: 15,),
